...
async def payment_success(message: Message):
    ...
    samozanyatost_guide = await ai_gen(
        "Ты эксперт по самозанятости.
Напиши гайд для подростка 14-17 лет: как оформить самозанятость, нужно ли согласие родителей, как платить налог. Простыми словами.",
